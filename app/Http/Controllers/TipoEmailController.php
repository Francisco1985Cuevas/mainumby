...
class TipoEmailController extends Controller
{
    ...
    {
        $tiposEmails = TipoEmail::all();
        return view('tipoEmail.list', ['tiposEmails' => $tiposEmails]);
    }
    ...
    public function store(Request $request)
    {
        ...
        // Creacion de registros utilizando Eloquent ORM, se hizo import de la clase(Model:TipoEmail) al
    ...
    {
        // Obtener el Tipo Email que corresponda con el ID dado (o null si no es encontrado).
