...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Actualizar Registro - Roles</h1>
</div>
<!-- End of Heading -->
		...
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{{ URL::route('roles.edit', [$rol->id]) }}" title="Actualizar P&aacute;gina Actual">
			...
			<div class="card-body">
				...
				{!! Form::model( $rol, ['route' => ['roles.update', $rol->id], 'method' => 'PUT' ]) !!}
					...
					<a data-id="{{$rol->id}}" href="#" id="btn_delete_editFormRol" class="btn btn-danger  btn-icon-split" title="Eliminar Registro">
				...
				<div class="modal fade" id="modal_delete_editFormRol" tabindex="-1" role="dialog" aria-labelledby="editFormModalLabelRol" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="editFormModalLabelRol">Eliminar Registro</h5>
								<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>

							<form id="form_delete_editFormRol" action="" method="post">
...
<script>
	...
	$("#btn_delete_editFormRol").click(function() {
        dataId = $(this).attr("data-id");
        //alert( "Handler for .click() called."+ dataId);
        $('#form_delete_editFormRol').attr('action', '/roles/'+dataId);
        $('#modal_delete_editFormRol').modal('show');
    });
</script>
@endpush
