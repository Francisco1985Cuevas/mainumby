...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Actualizar Registro - Documentos</h1>
</div>
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{{ URL::route('documentos.edit', [ $documento->id]) }}" title="Actualizar P&aacute;gina Actual">
			...
			<div class="card-body">
				...
				@if(Session::has('message'))
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						<i class="fas fa-check-circle"></i> {{Session::get('message')}} <a href="{!!URL::to('/documentos')!!}">Ver</a>
				...
				{!! Form::model(  $documento, ['route' => ['documentos.update',  $documento->id], 'method' => 'PUT' ]) !!}
					@include('documento.forms.formulario')
					...
					<a data-id="{{ $documento->id}}" href="#" id="btn_delete_editFormDocumento" class="btn btn-danger" title="Eliminar Registro">
				...
				<div class="modal fade" id="modal_delete_editFormDocumento" tabindex="-1" role="dialog" aria-labelledby="editFormModalLabelDocumento" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="editFormModalLabelDocumento">Eliminar Registro</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>

							<form id="form_delete_editFormDocumento" action="" method="post">
