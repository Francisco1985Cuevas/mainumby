...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Listado Principal - Documentos</h1>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{!!URL::to('/documentos')!!}" title="Actualizar P&aacute;gina Actual"><i class="fas fa-sync-alt"></i> Actualizar</a>
					</div>
				</div>
			</div>
			...
			<div class="card-body">
				...
				@if (count($documentos) > 0)
						...
						<table class="table table-bordered" id="dataTable_documentos" width="100%" cellspacing="0">
							...
							<tbody>
								@foreach($documentos as $documento)
									<tr>
										<td>{{$documento -> id}}</td>
										<td>{{$documento -> persona_nombres}}</td>
										<td>{{$documento -> tipo_documento_desc}}</td>
					...
					Controlador "DocumentoController" que realiza la paginacion de los recursos mostrados. -->
