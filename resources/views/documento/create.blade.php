...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Nuevo Registro - Documentos</h1>
</div>
	...
	<div class="col-xl-12 col-lg-12">
		...
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{!!URL::to('/documentos/create')!!}" title="Actualizar P&aacute;gina Actual">
			...
			<div class="card-body">
				...
				{!! Form::open(['route' => 'documentos.store', 'method' => 'post', 'id' => 'paisForm']) !!}
