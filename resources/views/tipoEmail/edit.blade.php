...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Actualizar Registro - Tipos de Correo electr&oacute;nico</h1>
</div>
<!-- End of Heading -->
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{{ URL::route('tiposemails.edit', [$tipoEmail->id]) }}" title="Actualizar P&aacute;gina Actual">
			...
			<div class="card-body">
				...
				@if(Session::has('message'))
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						<i class="fas fa-check-circle"></i> {{Session::get('message')}} <a href="{!!URL::to('/tiposemails')!!}">Ver</a>
				...
				{!! Form::model( $tipoEmail, ['route' => ['tiposemails.update', $tipoEmail->id], 'method' => 'PUT', 'id' => 'editTipoEmailForm' ]) !!}
					...
					<a data-id="{{$tipoEmail->id}}" href="#" id="btn_delete_editFormTipoEmail" class="btn btn-danger btn-icon-split" title="Eliminar Registro">
				...
				<div class="modal fade" id="modal_delete_editFormTipoEmail" tabindex="-1" role="dialog" aria-labelledby="editFormModalLabelTipoEmail" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="editFormModalLabelTipoEmail">Eliminar Registro</h5>
								<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>

							<form id="form_delete_editFormTipoEmail" action="" method="post">
