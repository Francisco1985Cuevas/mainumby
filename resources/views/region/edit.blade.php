...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Actualizar Registro - Regiones</h1>
</div>
<!-- End of Heading -->
		...
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{{ URL::route('regiones.edit', [$region->id]) }}" title="Actualizar P&aacute;gina Actual">
			...
			<div class="card-body">
				...
				{!! Form::model( $region, ['route' => ['regiones.update', $region->id], 'method' => 'PUT' ]) !!}
					...
					<a data-id="{{$region->id}}" href="#" id="btn_delete_editFormRegion" class="btn btn-danger  btn-icon-split" title="Eliminar Registro">
				...
				<div class="modal fade" id="modal_delete_editFormRegion" tabindex="-1" role="dialog" aria-labelledby="editFormModalLabelRegion" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="editFormModalLabelRegion">Eliminar Registro</h5>
								<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>

							<form id="form_delete_editFormRegion" action="" method="post">
...
<script>
	...
	$("#btn_delete_editFormRegion").click(function() {
        dataId = $(this).attr("data-id");
        //alert( "Handler for .click() called."+ dataId);
        $('#form_delete_editFormRegion').attr('action', '/regiones/'+dataId);
        $('#modal_delete_editFormRegion').modal('show');
    });
</script>
@endpush
