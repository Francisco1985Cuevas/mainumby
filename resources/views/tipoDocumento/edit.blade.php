...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Actualizar Registro - Tipos Documentos</h1>
</div>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				{!! Form::model( $tipoDocumento, ['route' => ['tiposdocumentos.update', $tipoDocumento->id], 'method' => 'PUT' ]) !!}
					...
					<a data-id="{{$tipoDocumento->id}}" href="#" id="btn_delete_editFormTipoDocumento" class="btn btn-danger" title="Eliminar Registro">
