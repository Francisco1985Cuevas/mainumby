<div class="form-group">
	{!! Form::label('idemail', '#C&oacute;digo Identificador') !!}
	{!! Form::label('idemail', '(Campo Autogenerado)', ['class' => 'text-xs']); !!}
...
{{--
value="{{  @empty($tipoEmail) ? old('nombre') : (@empty(old('nombre')) ? $email->nombre : old('nombre')) }}"
value="{{ isset($tipoEmail) ? (isset(old('nombre')) ? old('nombre') : $tipoEmail->nombre) : old('nombre') }}"
--}}
