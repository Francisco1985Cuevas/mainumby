...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Listado Principal - Departamentos</h1>
	<a href="{!!URL::to('/departamentos/create')!!}" class="btn btn-primary btn-icon-split" title="Nuevo Registro">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{!!URL::to('/departamentos')!!}" title="Actualizar P&aacute;gina Actual"><i class="fas fa-sync-alt"></i> Actualizar</a>
					</div>
				</div>
			</div>
			...
			<div class="card-body">
				...
				@if (count($departamentos) > 0)
					<div class="table-responsive">
						<table class="table table-bordered" id="dataTable_departamentos" width="100%" cellspacing="0">
							<thead>
								<tr>
									<th>#ID</th>
									<th>Nombre Depto.</th>
							...
							<tbody>
								@foreach($departamentos as $departamento)
									<tr>
										...
										<td>
											<a href="{{ URL::route('departamentos.edit', [$departamento -> id]) }}" class="btn btn-primary" title="Editar Registro">
												<i class="fas fa-edit"></i>
											</a>
											<a href="{{ URL::route('departamentos.show', [$departamento -> id]) }}" class="btn btn-success" title="Ver Detalles del Registro">
				...
				@else
					<div class="alert alert-info" role="alert">
                        ...
                        <hr />
                        <p>
                            <strong>Tabla:</strong> Departamentos
                            <br/>
