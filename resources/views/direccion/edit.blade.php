...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Actualizar Registro - Direcciones</h1>
</div>
	...
	<div class="col-xl-12 col-lg-12">
		...
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{{ URL::route('direcciones.edit', [$direccion->id]) }}" title="Actualizar P&aacute;gina Actual">
			...
			<div class="card-body">
				...
				{!! Form::model( $direccion, ['route' => ['direcciones.update', $direccion->id], 'method' => 'PUT' ]) !!}
					...
					<a data-id="{{$direccion->id}}" href="#" id="btn_delete_editFormDireccion" class="btn btn-danger" title="Eliminar Registro">
				...
				<div class="modal fade" id="modal_delete_editFormDireccion" tabindex="-1" role="dialog" aria-labelledby="editFormModalLabelDireccion" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="editFormModalLabelDireccion">Eliminar Registro</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>

							<form id="form_delete_editFormDireccion" action="" method="post">
