                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionPersona">
                                <div class="accordion-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tipo_persona" id="tipo_persona" class="form-control" autofocus>
                                    ...
                                    @if (count($listaPaises) > 0)
                                        <div class="form-group">
                                            ...
                                            {!! Form::label('pais_id', '(Campo opcional)', ['class' => 'text-xs']); !!}
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        {{-- {!! Form::label('region_id', '(Campo opcional)', ['class' => 'text-xs']); !!} --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::label('departamento_id', '(Campo opcional)', ['class' => 'text-xs']); !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::label('ciudad_id', '(Campo opcional)', ['class' => 'text-xs']); !!}
