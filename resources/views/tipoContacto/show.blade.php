...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Detalles del Registro - Tipos de Contacto Telefonico</h1>
</div>
<!-- End of Heading -->
...
<div class="row">
	<div class="col-xl-12 col-lg-12">
		...
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{{ URL::route('tiposcontactos.show', [$tipoContacto->id]) }}" title="Actualizar P&aacute;gina Actual">
			...
			<div class="card-body">
				{!!Form::model($tipoContacto, ['route'=>  ['tiposcontactos.show', $tipoContacto->id], 'method'=>'POST', 'files'=> true])!!}
                    @include('tipoContacto.forms.formulario-detalle')
                    <a href="{!!URL::to('/tiposcontactos')!!}" class="btn btn-primary btn-icon-split">
