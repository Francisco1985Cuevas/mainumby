...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Listado Principal - Pa&iacute;ses</h1>
	<a href="{!!URL::to('/paises/create')!!}" class="btn btn-primary btn-icon-split" title="Nuevo Registro">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				...
				<div class="dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item" href="{!!URL::to('/paises')!!}" title="Actualizar P&aacute;gina Actual"><i class="fas fa-sync-alt"></i> Actualizar</a>
					</div>
				</div>
			</div>
			...
			<div class="card-body">
				...
				@if (count($paises) > 0)
					<div class="table-responsive">
						<table class="table table-bordered" id="dataTable_paises" width="100%" cellspacing="0">
							<thead>
								<tr>
									<th>#ID</th>
									<th>Nombre</th>
							...
							<tbody>
								@foreach($paises as $pais)
									<tr>
										...
										<td>
											<a href="{{ URL::route('paises.edit', [$pais -> id]) }}" class="btn btn-primary" title="Editar Registro">
												<i class="fas fa-edit"></i>
											</a>
											<a href="{{ URL::route('paises.show', [$pais -> id]) }}" class="btn btn-success" title="Ver Detalles del Registro">
					...
					Controlador "PaisController" que realiza la paginacion de los recursos mostrados. -->

                    <!-- delete question Modal -->
					<div class="modal fade" id="modal_delete_listPais" tabindex="-1" role="dialog" aria-labelledby="listModalLabelPais" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
								...
								<form id="form_delete_listPais" action="" method="post">
